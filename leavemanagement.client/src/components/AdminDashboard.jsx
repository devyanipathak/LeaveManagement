        ...
        try {
            await apiFetch('/leaverequests/process-approval', {
                ...
                body: JSON.stringify({
                    ...
                    status,
                    managerComment:
                        this.state.commentDrafts[requestId] || ''
                })
            });
    ...
    renderAssignTab() {
        ...
        const assignEmployee = async () => {
            ...
            if (employee === "" || manager === "") {
                ...
                this.setState({
                    assignError:
                        'Please select both a manager and an employee.'
                });

                Swal.fire({
                    icon: 'warning',
                    title: 'Selection Required',
                    text: 'Please select both a manager and an employee.',
                    confirmButtonText: 'OK'
                });
            ...
            // Same employee and manager validation
            if (employee === manager) {

                this.setState({
                    assignError:
                        "Employee and Manager can't be the same person."
                });

                Swal.fire({
                    icon: 'warning',
                    title: 'Invalid Selection',
                    text: "Employee and Manager can't be the same person.",
                    confirmButtonText: 'OK'
                });
            ...
            const result = await Swal.fire({
                ...
                text: 'Are you sure you want to assign this manager to the selected employee?',
                showCancelButton: true,
            ...
            try {
                ...
                await this.loadUsersAndManagers();

                Swal.fire({
                    icon: 'success',
                    title: 'Manager Assigned',
                    text: 'The manager has been assigned successfully.',
                    timer: 1800,
                    showConfirmButton: false
                });
